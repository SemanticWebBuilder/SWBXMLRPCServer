...
public class WBFileUpload {
	...
	public boolean saveFile(String s, String s1) throws IOException {
		boolean flag = false;
		if (table == null) {
			return false;
		}
				...
				if (obj instanceof Hashtable) {
					...
					if (s3 != null) {
						...
						FileOutputStream fileoutputstream = new FileOutputStream(
								String.valueOf(s1) + String.valueOf(s3));
			...
			if (s3.equals(s)) {
				...
				if (obj instanceof Hashtable) {
					...
					if (s4 != null) {
						...
						FileOutputStream fileoutputstream = new FileOutputStream(
								String.valueOf(s1) + String.valueOf(s2));
						fileoutputstream.write(abyte0, 0, abyte0.length);
						fileoutputstream.close();
					}
				}
				...
				if (obj instanceof Hashtable) {
					...
					if (s3 != null) {
						...
						FileOutputStream fileoutputstream = new FileOutputStream(String.valueOf(s1) + String.valueOf(s3)
								+ String.valueOf(smod1) + String.valueOf(smod2));
						fileoutputstream.write(abyte0, 0, abyte0.length);
						fileoutputstream.close();
					}
				}
	 ...
	 *             If is not possible to read the files
	 */
	...
	Hashtable parseMulti(String s, ServletInputStream servletinputstream) throws IOException {
		...
		do {
			...
			if (!s10.equals("form-data")) {
				throw new IllegalArgumentException(String.valueOf(String.valueOf(
						(new StringBuffer("Content Disposition of ")).append(s10).append(" is not supported"))));
			}
